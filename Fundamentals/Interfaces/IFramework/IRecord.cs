...
{
    public interface IRecord : IArchive, IReadWrite, IRelate, IFramework // this evidently needs to be a configured service with DI to avoid anti-patterns https://learn.microsoft.com/en-us/dotnet/core/extensions/dependency-injection
    {
